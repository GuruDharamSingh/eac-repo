...
export function RichTextEditor({
  ...
  const editor = useEditor({
    ...
    onUpdate({ editor }) {
      // Treat empty editor as empty string so saved drafts don't show <p></p>.
  ...
  // Keep external resets / form clears in sync with editor state.
  React.useEffect(() => {
    if (!editor) return;
