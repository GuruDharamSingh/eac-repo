...
export default async function DashboardPage() {
  ...
  const acceptedRSVPs = myRSVPs.filter(rsvp => rsvp.attendanceStatus === "attended").length;
  const now = new Date();
  const upcomingMeetings = allMeetings.filter(meeting => meeting.startTime && meeting.startTime > now).length;
